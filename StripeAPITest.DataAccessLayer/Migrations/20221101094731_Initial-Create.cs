...
namespace StripeAPITest.DataAccessLayer.Migrations
{
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PayerCoordinates = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    PayeeCoordinates = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ChargeCoordinates = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "Authorize" });

            migrationBuilder.InsertData(
                table: "TransactionTypes",
                columns: new[] { "TransactionTypeId", "TransactionTypeName" },
                values: new object[] { 2, "Capture" });

            migrationBuilder.InsertData(
                table: "TransactionTypes",
                columns: new[] { "TransactionTypeId", "TransactionTypeName" },
                values: new object[] { 3, "Void" });
